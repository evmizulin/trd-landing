            ...
            <div className="hero-content">
              ...
              <div className="container-xs">
                <p className="m-0 mb-16 reveal-from-bottom" data-reveal-delay="400">
                  Fully automated trading on the stock market.
                </p>
                <p className="m-0 mb-16 reveal-from-bottom" data-reveal-delay="400">
                  Proven return of <span className="text-color-primary">80% per annum</span>.
                </p>
                <p className="m-0 mb-32 reveal-from-bottom" data-reveal-delay="400">
                  Source code and exclusive rights are for sale.
                </p>
